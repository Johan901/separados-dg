...
<body>
    ...
    <header>
        ...
        <div class="header-right">
            <form action="inventario_bodeguero.php" method="GET" class="search-form">
    ...
    while ($producto = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "<tr>
            ...
            <td>{$precio_por_mayor_formateado}</td>
                <td><a href='agregar_cantidad_bodeguero.php?ref={$producto['ref']}&color=" . urlencode(trim($producto['color'])) . "' class='button'>Agregar Cantidad</a></td>
        </tr>";
    }
    echo "</table>";
    ?>
