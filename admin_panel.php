...
<body>
    ...
    Dulce Guadalupe
    <img src="assets/images/LOGOCORAZON.png" alt="" style="vertical-align: middle; margin-left: 10px; width: 60px; height: 60px;">
    </h2>
    ...
    <div class="sections">
        ...
        <div class="section" style="background-color: #b2dfdb;">
            ...
            <div class="dropdown">
                ...
                <a href="generaar_inventario.php">Generar Inventarios</a>
            </div>
        </div>
