...
<body>
    ...
    <header>
        <div class="hamburger-menu">
            ...
            <div class="dropdown-menu">
                ...
                <a href="agregar_referencia.php">Agregar nueva referencia</a>
    ...
    <form action="agregar_inventario.php" method="post" class="user-edit-form">
        ...
        <label for="precio_al_detal">Precio al Detal:</label>
